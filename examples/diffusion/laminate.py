...
def func_to_png(
    filename, V, v, save=False, cmap="viridis", vmin=None, vmax=1.3934988798958294, title=None
):
...
func_to_png("diffusion_wavy_laminate_reference", V_ref, u_ref, save=True, title="$u_\\text{ref}$")
...
func_to_png(
    "diffusion_wavy_laminate_coefficient",
    V_ref,
    coeff,
    cmap="gray",
    save=True,
...
plotter.show()
func_to_png(
    "diffusion_wavy_laminate_stratified_hmm",
